...
--Operador de BD 
--Between (entre) - intervalo sequencial
-- sintaxe where campo between valor_inicial and valor_final;
select * from pedido where num_pedido between 98 and 119;

--Exibir o nome dos clientes e o estado onde moram, 
--desde que morem em SP e RJ.
...
-- like 
--opções % - qualquer quantidade
--       _ - posição específica
*/
--Exibir todos os clientes que começam com a letra A
select * from cliente where nome_clie like 'A%';
--Exibir todos os clientes que terminem com a letra A
select * from cliente where nome_clie like '%a';
--contenha a
select * from cliente where nome_clie like '%ana';
select * from cliente where nome_clie like '___a%';
